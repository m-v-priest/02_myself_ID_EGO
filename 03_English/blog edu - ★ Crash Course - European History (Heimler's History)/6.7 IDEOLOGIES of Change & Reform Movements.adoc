...
Okay, now `主` another ideology *springing up* 涌现 during this time `系` was socialism 社会主义, which when *being defined as* an ideology /*that demands (v.) that* `主` a society's means (n.) of production 生产资料 `谓` should be owned by the community as a whole, not by private individuals 私人个体. Essentially 本质上；基本上 a call (n.) for a redistribution 重新分配 of a society's wealth. +
