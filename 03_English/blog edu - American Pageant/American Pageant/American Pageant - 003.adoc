...
The group Quakers 贵格会；贵格会信徒 was actually known as _the Religious Society 宗教团体 of Friends_ 朋友教团,宗教教友会 (Quakers was their nickname). +

They're pacifists 和平主义者, they were treated very poorly 待遇很差 in England, and so William Penn wants to establish (v.) this colony /and the crown 王国政府，王国 grants (v.) him _a block of land_ 一块土地. +
 This is a proprietorship (所有权) 业主殖民地. +
 Penn creates (v.) a very liberal 思想开明的；自由主义的 colony 自由殖民地 - there is representative assembly 代议制议会 (people *are voting for* representation), he seeks to treat (v.) the Native Americans very fairly /by buying land from them /*rather than* just taking it. +
 There is widespread religious toleration 广泛的宗教宽容 and freedom in Pennsylvania, and certain rights *are extended to* women as well - they have a right to be active in the church /and *to even be* preachers 传教士 (things that did not happen (v.) in the New England colonies). +


`主` _Some key things_ about the middle colonies *to keep in mind* /`系` is they are going to be _demographically 人口统计地, religiously, and ethnically 人种上；民族上  diverse_ (a.不同的，各式各样的) 人口、宗教和种族多元化. +
 So you got a mix of people in this area /whether it be the Dutch, the Quakers, Protestants 新教徒, Puritans, and so on. +
 And their economics `系` are *like I said* - "Bread Basket" 面包篮子 -- they're going to be producing (v.) food especially wheat and corn, but they're also going to *be involved in* trade 贸易 and other things. +


Now that 既然，由于 we'*ve broken down* 分析完 all the different regions of the colonies, *make sure you understand* some colonial policy 殖民政策. +
 Remember (v.)  `主` the colonies `系` are there /because of this economic theory *known as* mercantilism 重商主义 - the colonies exist (v.) *to enrich (v.)使富裕 the mother country* 母国 (in this case England). +
 However, in this early period /you have this thing called _salutary 有益的，(a.)有用的；有益健康的 neglect_ 有益的忽视. +

[.my1]
.案例
====
.salutary
-> 萨卢斯（Salus）是罗马神话中的健康女神，掌管健康、幸福和兴盛。
====

England *was involved in* its own internal conflicts 内部冲突 such as the English Civil War, and so they're going to *be largely indifferent (a.)冷淡的，不关心的 to* 漠不关心 the colonies - they're going to kind of *be letting them do their own thing* 放任自流 for a big chunk of this time 在这段时间的大部分时间里. +


There are some exceptions though 不过也有一些例外 -- we have some policies 政策，方针 that *are put in place* 实施,安置好，落实好, some _mercantile (a.)贸易的，商业的；营利主义的 laws_ 商法, 商业法律 such as the Navigation Acts 航海条例. +
 And this is really England trying *to keep watch 监管 over* its colonies. +
__ The Navigation Acts__ did things like:  +
1) trade (n.) must *be carried* only on English or colonial ships 英国或殖民地船只;  +
2) trade had to *pass through* English ports 英国港口 /before it can *move on to* other places such as France;  +
and 3) `主` certain enumerated goods 特定列举商品 (certain goods that *are spelled out* 清楚地说明,列明) from the colonies `谓` could *be exported only to* England (and it *starts off 以……开始 with* tobacco, but other goods are only allowed *to be traded with* England). +
...
There is very loose enforcement 松散执法 in the beginning - in fact, smuggling 走私 was a major problem. + 
 ...
 There are going to be instances 例子；实体 where England's going to try *to clamp (v.)（用夹具）夹紧，夹住 down 压制,加强取缔,严格限制,施压力于 on*  the colonies. +

You could see that /`主` whole region in the green `谓` is going to be something called _the Dominion 主权，统治权；支配；领土 of New England_ 新英格兰自治领 in 1686. +
 This is implemented by England /to increase (v.) royal control 加强王室控制 over the colonies, and the King *sends over* 发送过去 an individual by the name of Sir Edmund Andros /to regulate (v.) and *keep* these colonies *in check* 受控制的；受抑制的,约束. +
 And he does a couple of things 后定 most of which are very unpopular - such as enforcing (v.) _the Navigation Acts_ (which the colonies were largely ignoring), limiting (v.) _the town hall meetings_ 市政厅会议 and other things. +


And it's important to note (v.) /`主` _the goals and interest_ of European leaders in England `谓` very often at times 有时候 *diverge (v.)相异，出现分歧 from* those of the colonists (殖民地居民) 在英国的欧洲领导人的目标和兴趣, 常常与殖民地人的目标和兴趣不同, and this *led to* mistrust 不信任 on both sides of the Atlantic. +
 This _Dominion of New England_ will eventually end (v.) with _the Glorious Revolution_ 光荣革命 in 1688 后定 which we'll take a look at next time. +

And until next time 下次课之前, I hope you learned (v.) a whole bunch of stuff 一大堆东西. +
 And if you did, click (v.) like on the video, tell your friends about Joe's Productions, subscribe (v.) to the channel. +
 If you have any questions or comments, post (v.) them in the comments section. +
