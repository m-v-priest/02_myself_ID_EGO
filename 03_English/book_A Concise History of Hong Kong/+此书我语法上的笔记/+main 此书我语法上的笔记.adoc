...
== 形容词/副词/名词 + as + 主语 + 谓语动词 : 让步状语从句的倒装结构，意思是 “尽管/虽然..."
...
== 虚拟语气/ could have done​ : 表达一种 “本可以发生，但实际并未发生”​ 的可能性。
...
== 虚拟语气 /would have done : 表示 “对过去情况的虚拟推测”​ 的典型结构。它描述的是 “过去本应发生，但实际上并未发生”​ 或 “对过去某事的推测”​ 的情况。
...
== had been doing sth :  表达两个过去动作之间的时间先后关系，并强调动作的“持续性”与“相关性”。
...
=== "became of + 抽象名词"，就相当于 "became + 形容词"
