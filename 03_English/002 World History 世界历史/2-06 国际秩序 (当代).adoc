...
In Europe, the European Parliament 议会，国会, the EU’s legislative 立法的；（与）立法机关（有关）的 body, was angry that Brexit might threaten the entire EU project. To show its displeasure and possibly to deter any other member states from leaving, the European Parliament wanted the separation to be as painful for the United Kingdom as possible, and many member countries supported this hardline stance.
