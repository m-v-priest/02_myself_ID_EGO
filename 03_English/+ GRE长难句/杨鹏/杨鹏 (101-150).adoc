...
- (101.) The correlation 相互关系；关联 of carbon dioxide 二氧化碳 with temperature, of course, does not establish 证实；确定 whether changes in atmospheric 大气的；大气层的 composition 构成；成分 caused the warming 变暖 and cooling 变冷 trends 趋势 or were caused by them.
