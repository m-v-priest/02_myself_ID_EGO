...
`主` ① #The dangers# 后定 posed (v.) by economic crisis /② #and the disillusionment# (n.)不再抱幻想；幻想破灭；醒悟 that came with _the collapse of *Revolutionary expectations* 期望；预期；期望值 for **dramatically 剧烈地，明显地 improved conditions**_  /`谓` #combined# to make the decade 十年，十年期  `宾补` _a period of discontent 不满，不满足, reconsideration_ 再议；再考虑；再审查, and, in the end, a dramatic 突然的；巨大的；令人吃惊的 new proposal 提议；建议；动议 for redirecting (v.)重新定向 the nation. +

Just as the Revolution *had been born of* _diverse 不同的，各式各样的 and sometimes conflicting 冲突的；相矛盾的 perspectives_ 态度；观点；思考方法, even among the Patriots, so too, `主` ideas about the future of the United States in the 1780s `谓` were often cast (v.) 方式状 in dramatic opposition （强烈的）反对，反抗，对抗 to one another.
...
The new plan for the nation was called the FEDERAL CONSTITUTION 美国联邦宪法. +
...
`主` The Constitution `谓` ① #amounted to# 总计；共计;等于；相当于 a whole new set of rules 后定 for organizing (v.) national government ② #and indicates# (v.)表明；显示 the intensity 强度；烈度;强烈；紧张；剧烈 of political thought 政治思想 in the era *as well as* 和，以及，还有 how much had changed since 1776. +

[.my1]
.案例
====
image:/img/112.svg[,100%]
====

`主` The proposed national framework `谓` *called for* a strong central government that would have authority over the states. +
At the same time, the proposed Constitution also centrally #involved# the people #in# _deciding (v.) whether or not to accept (v.) the new plan 方式状 through a process 后定 called RATIFICATION 批准，认可_.
...
Many were strong nationalists 国家主义者 who ① thought (v.) the Articles of Confederation *gave too much power to* the states /② and were especially *concerned about* _state governments' vulnerability_ 易损性，弱点 to _powerful local interests_. +

Instead, the delegates 代表 to the Philadelphia Convention `谓` aimed to create _an energetic 精力充沛的，充满活力的；积极的 NATIONAL GOVERNMENT_ that could *deal effectively with* the major problems of the period #from# _external 外部的；外面的 matters_ of _diplomacy and trade_ #to# _internal issues_ of _sound (a.)完好的；健康的；无损伤的；未受伤的 money_ 稳定的货币 and _repayment of public debt_.
...
In spite of the common vision and status 后定 that *linked* (v.) most of the delegates *to* the Philadelphia Convention, `主` *no obvious route `谓` existed* (v.) for how to revise (v.)改变，修改（意见或计划） the Articles of Confederation to build a stronger central government.

[.my2]
尽管大多数代表, 与费城会议有着共同的愿景和地位，但对于如何修改《邦联条例》以建立一个更强大的中央政府，并不存在明显的途径。
...
They also decided to continue _the voting precedent_ 前例；先例 后定 followed by the Congress where _each state got one vote_.
...
The delegates felt (v.) that `主` secrecy 面秘密，保密 `谓` would allow them to explore issues [with greater honesty] #than# would be possible if `主` everything 后定 that they said `谓` became public knowledge.
...
The delegates also `谓` made _a final crucial 至关重要的，决定性的 and sweeping 影响广泛的；大范围的；根本性的 early decision_ 后定 about how to run the Convention （某职业、政党等成员的）大会，集会. +
They agreed to go beyond the instructions of the Congress /by #not# merely considering (v.) _revisions (n.)修改; 修正 to the Articles of Confederation_, #but# to try and construct (v.) a whole new national framework.

[.my2]
代表们还就"如何举办大会", 做出了最后的关键和全面的早期决定。他们同意超越国会的指示，不仅考虑修改《邦联条例》，而且尝试构建一个全新的国家框架。


After _still more deeply divided 分裂的，有分歧的 argument_, a proposal *put forward* by delegates from Connecticut (a small population state ), *struck (v.)撞击；碰撞 a compromise* 达成妥协  后定 that narrowly got approved. +

They suggested that `主` representatives 后定 in _each house_ of _the proposed bicameral legislature_ 两院制立法机构 *be selected* through different means. +
The UPPER HOUSE (or SENATE) *would reflect* the importance of state sovereignty 主权，最高统治权 *by including* two people from each state *regardless of* size. +
Meanwhile, the LOWER HOUSE (the HOUSE OF REPRESENTATIVES) would have _different numbers of representatives_ from each state 后定 determined 决定；支配 by population. +
...
[.my2]
在更深刻的争论之后，康涅狄格州（一个人口较少的州）的代表, 提出的一项提案达成了妥协，以微弱优势获得批准。他们建议, 通过不同的方式选出拟议的"两院制立法机构"两院的代表。 +
上议院（或参议院）将通过包括"来自每个州的两个人", 来反映"州主权"的重要性，无论大小。 +
同时，下议院（众议院）将有不同数量的代表，每个州的代表人数由人口决定。 +
代表性将每十年通过一次联邦人口普查进行调整，该人口普查将计算该国的每个人。

By *coming up with* 想出，提出 a mixed solution that *balanced* (v.) state sovereignty *and* popular sovereignty 后定 tied to actual population, the Constitution was forged 锻造；制作  `方式状` through *what is known as* the CONNECTICUT COMPROMISE 康涅狄格妥协. +

In many respects /this compromise reflected a victory for small states, but *compared with* 与…相比 _their dominance in the Congress_ under the Articles of Confederation /it is clear that *negotiation produced (v.) something* 后定 that #both# small #and# large states wanted.
...
One of the major issues `谓` concerned (v.)与…有关；涉及 _elections themselves_. +
...
The delegates needed to figure out a solution that could #satisfy# (v.)使满意；使满足 _people 后定 with many different ideas_ #about# who could have the franchise （公民）选举权 (that is, who could be a voter).
...
For the popular _lower house_ 下议院, `主` any white man who paid taxes `谓` could vote. +
Thus, even those without property, could vote (v.) for who would represent them in _the House of Representatives_ 众议院. +
This expanded (v.) the franchise （公民）选举权 in some states. +

To balance (v.) this opening 孔；洞；缺口, `主` the two Senators in _the upper house of the national government_ `谓` would be elected by the STATE LEGISLATURES. +
...
[.my2]
对于受欢迎的下议院来说，"任何纳税的白人"都可以投票。因此，即使是那些没有财产的人，也可以投票选出谁将在"众议院"代表他们。这扩大了某些州的"公民选举权"。为了平衡这一空缺，国家政府"上议院"的两名参议员, 将由"州立法机构"选举产生。最后，总统（即行政部门）将通过"选举团"在州一级选举产生，选举团的人数, 反映了立法机关的代表权。
...
选举人团 Electoral College 是美国总统选举的方式，是一种间接选举，旨在选出"总统"和"副总统"。 +
美国各州公民, 先选出该州的选举人，**再由"选举人"代表该州投票，所以美国总统并非"公民直选"。**不采用"普选制度"的原因在于, 美国为联邦制国家，制宪元老考虑到各州自治性，采取"选举人团制度"保障各州权益。

- 一个州为一个"选举人团"单位。**各州的选举人数, 即该州在"参众两院"议员总人数。**例如：纽约州有2位参议员, 与27位众议员，所以共有29张选举人票。 +

- **目前美国共设有538名选举人，比照100位参议员, 与435位众议员的结构，外加首都华盛顿特区特有的3张选举人票。** +
各州当中, 以加利福尼亚州选举人票最多，达54张；得克萨斯州40张，佛罗里达州30张，纽约州28张；而阿拉斯加、特拉华、怀俄明等州最少，只有3张。

- *得到超过半数"选举人票"（至少270票）的总统候选人, 获胜。*


- 1961年批准的第二十三条宪法修正案, 给予"华盛顿特区"选举权，同时**规定"特区"所拥有的选举人票数, 不得超过"人口最少之州"的选举人票数（即3人），因此"华盛顿特区"所拥有的选举人, 至今为3人。**

- *如果所有候选人, 都未能获得半数以上的选举人票，则由"众议院"从得票最多的前三名候选人中, 选出总统。*
...
The Constitution created a national legislature 后定 ① that #could# pass (v.) the supreme law 最高法律 of the land, ② #could# raise taxes, ③ and with greater control over commerce. +
The proposed rules also would restrict (v.) state actions, especially in regard to 关于，就……而言 passing (v.) PRO-DEBTOR 亲债务人 LAWS. +
...
This small group of national superstars `谓` had created a major new framework 方式状 through hard work and compromise.
...
Could they convince (v.)使确信，使信服；说服，劝服 the public that `主` the weak central government of the Articles of Confederation `谓` needed to be strengthened?  +
...
*Aware of* the major challenge before them, `主` the framers 制宪者；筹划者 of the new plan `谓` crafted a startling 惊人的；让人震惊的 new approach （待人接物或思考问题的）方式，方法，态度   `方式状` through a _ratifying 认可，正式批准 procedure_ that went directly to the people. +
...
*Building on* a model 后定 adopted by Massachusetts in passing its state constitution of 1780, `主` the framers suggested that /`主` constitutional law `系` was of #such# sweeping significance #that# it would be inappropriate 不恰当的，不合适的 to have it approved 方式状 though ordinary political channels.
...
Instead, special conventions should be held 目的状 for the people to evaluate  (v.)估计；评价；评估 such important changes. +
Politicians 政治家，政客 in Congress *were well aware of* the weaknesses of the current central government /and shared the framers' sense that the state legislatures *were very likely (a.) to* oppose the new plan, so Congress approved the new terms （协议、合同等的）条件，条款 of _this unusual, and even illegal, ratification 批准，认可 route_ 途径；渠道. +
Surprisingly, so too did state legislatures 后定 that began *arranging for* _the election of special delegates_ to _the state ratification conventions_.
...
`主` Their adopted (a.)收养的；领养的 name `谓` implied a commitment to _a loose, decentralized 分散管理的;使分散；使分权 system of government_. +
...
In addition to 除了……之外 these impressive superstars, the Federalists were well organized, well funded 资助, and made especially careful use (n.) of the printed word. +
...
The ANTIFEDERALISTS 反联邦主义者 were a diverse 不同的，各式各样的 coalition （尤指多个政治团体的）联合体，联盟 of people who opposed (v.) ratification of the Constitution. +
...
In spite of the diversity (n.)差异（性）；不同（点） 后定 that characterized (v.)是…的特征；以…为典型 the Antifederalist opposition （强烈的）反对，反抗，对抗, they did share (v.) a core view of American politics. +
...
All three branches of the new central government `谓` threatened _Antifederalists' traditional belief_ in the importance of restraining (v.)抑制；限制；克制（情感） government power.
...
Furthermore, they would represent (v.) people from #such# a large area 如此...以致 #that# they couldn't really know their own constituents （选区的）选民，选举人;成分；构成要素. +
...
Since the new legislature was to have increased _fiscal 财政的；国库的 authority_, especially the right 后定 to raise taxes, the Antifederalists feared (v.) that `主` before long 不久之后 Congress `谓` would pass (v.) _oppressive 压迫的；压制的；高压的 taxes_ 苛税 后定 that they would enforce by creating a standing national army.
...
This range of objections 反对的理由；反对；异议 *boiled (v.) down to* 归结为; 概括；归纳；压缩 _a central 最重要的；首要的；主要的 opposition_ to _the sweeping 影响广泛的；大范围的；根本性的 new powers_ of _the proposed central government_. +
`主` George Mason, a delegate to the Philadelphia Convention who refused to support the Constitution, `谓` explained, the plan was "totally subversive (a.)颠覆性的；暗中起破坏作用的 of _every principle_ which has hitherto 迄今，至今 governed (v.) us. +

This power is calculated (v.)计算；核算;预测；推测;精心策划的；蓄意的 *to annihilate (v.)消灭；歼灭；毁灭 totally* the state governments."  +
`主` The rise of national power *at the expense of* state power `系` was a common feature 特点，特征;五官，面貌（特征） of Antifederalist opposition.
...
`主` The most powerful objection 反对的理由；反对；异议 raised by the Antifederalists, however, `谓` *hinged 给（某物）装铰链 on* 有赖于；取决于 the lack of _protection for INDIVIDUAL LIBERTIES_ in the Constitution. +
Most of the state constitutions 宪法；章程 of the era `谓` had built [on the Virginia model] that included _an explicit 直截了当的；不隐晦的；不含糊的 protection of individual rights_ that could not *be intruded 扰乱；侵扰 upon* by the state. +
...
*Why*, then, *had* the delegates to the Philadelphia Convention *not #included#* a bill of rights 权利法案 #in# their proposed Constitution?  +
Most Antifederalists thought that /such protections were not granted /because the Federalists represented (v.) a sinister (a.)邪恶的；险恶的；不祥的；有凶兆的 movement to roll back 击退；使后退;降低，削减（价格等） the gains 后定 made for ordinary people during the Revolution.
...
The ratification process started /when the Congress 代表大会 *turned* the Constitution *over to* 移交给 the state legislatures for consideration 方式状  through 以；凭借；因为；由于 specially elected (a.) state conventions 大会，集会 of the people. +

Five state conventions voted (v.) to approve the Constitution almost immediately (December 1787 to January 1788) /and in all of them the vote was unanimous （决定或意见）一致的，一致同意的 (Delaware, New Jersey, Georgia) or lopsided (a.)一侧比另一侧低（或小等）的；向一侧倾斜的；不平衡的 (Pennsylvania, Connecticut). +

Clearly, the well-organized Federalists began the contest [in strong shape] /as they rapidly secured (v.)（尤指经过努力）获得，取得，实现;保护；保卫；使安全 five of the nine states 后定 needed to make the Constitution law. +
The Constitution seemed to have easy, broad, and popular 普遍的；大众的；流行的 support.
...
`主` Four of the five states to first ratify `系` were small states 后定 that stood to benefit from a strong national government 后定 that could restrain (v.) abuses by their larger neighbors.
...
The PENNSYLVANIA STATE ASSEMBLY 州议会 was about to *have its term 期限；任期 come to an end*, and had begun to consider *calling (v.) a special convention* on the Constitution, even before Congress had forwarded (v.)发送，寄（商品或信息） it to the states. +

Antifederalists 反联邦主义者 in the state assembly `谓` tried to block this move by refusing to attend the last two days of the session （议会等的）会议，会期, since without them /there would not be enough members present (v.) for the state legislature 州立法机构 to make a binding (a.)必须遵守的；有法律约束力的 legal decision. +

As a result /`主` extraordinarily coercive (a.)用武力的；强制的；胁迫的 measures `谓` were taken to force Antifederalists to attend. +
...
_The presence of these Antifederalists_ against their will, created _the required number of members_ to allow a special convention to be called 下令举行；宣布进行 in the state, which eventually voted 46 to 23 to accept the Constitution.
...
`主` The first _real test_ of the Constitution in an influential 有很大影响的；有支配力的 state /with both sides *prepared for* the contest `谓` came in Massachusetts in January 1788. +
...
A bitterly divided (a.)分裂的；有分歧的 month-long 为期一整个月的 #debate# ensued (v.)接着发生；因而产生 /后定 #that# ended 状 with _a close 实力相差无几的；仅以些微之差获胜的 vote_ (187-168) in favor of the Constitution. +
...
But with powerful, populous 人口众多的；人口密集的, and highly divided Virginia and New York yet to vote, `主` the legitimacy 合法性，合理性 of the new national system `谓` had not yet been fully resolved.
...
`主` The opponents 对手 of the Constitution `谓` ① had a strong majority when the convention began ② and set (v.) a tough challenge 严峻的挑战 for ALEXANDER HAMILTON, the leading 最重要的；一流的 New York Federalist. +
Hamilton managed (v.) a brilliant campaign that narrowly won (v.) the issue 重要议题；争论的问题 (30-27) by *combining threat 威胁，恐吓 and accommodation* 和解；调解；调和. +

#On the one hand#, he warned (v.) that _commercial down state areas_ might separate from _upstate New York_ if it didn't ratify (v.). +
#On the other hand#, he accepted _the conciliatory (a.)调解的；抚慰的；意在和解的；和解的 path_ 后定 suggested by Massachusetts; amendments would be acceptable after ratification.
...
====
.upstate New York
纽约上州（英语：Upstate New York），美国口语中泛指纽约州除了纽约市及长岛地区以外的所有地区，并无官方或正式的行政界线；该区主要以家庭居住的市郊（Suburb）为主，间有几座城市（水牛城、罗彻斯特等），有别于纽约市区（Downtown、Urban Area）。
...
Together they tried to *assure* (v.)使确信；向…保证 the public *of* the two key points of the Federalist agenda （政治）议题;待议事项，议事日程. +
...
Second, it tried to convince (v.)使确信；使相信；使信服 readers that because of _the "separation" of powers_ 分权, 权力分立 in the central government, there was little chance of the national government 后定 evolving into a tyrannical 暴君的；专横的；残暴的 power. +

Instead of 代替，而不是 growing ever stronger, the separate branches would provide (v.) _a "CHECK AND BALANCE" 制衡 against each other_ so that none could rise (v.) to complete dominance 优势，支配地位.
...
The influence of these newspaper letters 后定 in the New York debate is not entirely known, but `主` their status as _a classic (a.n.)有代表性的；典型的;经典作品，名著，杰作 of American political thought_ 政治思想 `系` is beyond doubt. +
...
Here Madison argued that a larger republic (n.)共和国；共和政体 would not lead to _greater abuse of power_ (as had traditionally been thought), but actually could work (v.) to make _a large national republic_ `宾补` a defense against tyranny (n.)暴虐；专横；苛政；专政. +

Madison explained that _the large scope 范围;（做或实现某事的）机会，能力 of the national republic_ would prevent local interests 地方利益 from rising to dominance (n.) /and therefore `主` the larger scale itself `谓` limited (v.) the potential (n.)（事物的）潜力，可能性  for abuse of power. +
...
Madison was one of the first political theorists 理论家 to offer _a profoundly 极大地；深刻地;严重地；完全地；彻底地 modern vision_ of _self-interest *as* an aspect of human nature_ that could be employed (v.)应用；运用；使用 to make government better, rather than more corrupt. +
In this /he represents (v.) _a key figure_ in the transition *from* a traditional republican vision of America, *to* a modern LIBERAL one /where self-interest has a necessary role to play in public life.
...
====
.profoundly
1.in a way that has a very great effect on sb/sth 极大地；深刻地 +
...
`主` The relatively (ad.)相当程度上；相当地；相对地 small states of North Carolina and Rhode Island `谓` would hold out （为得到利益）拖延达成协议 longer, but with 11 states ratifying (v.) /and all the populous (a.)人口众多的；人口密集的 ones among them, the Federalists had successfully waged (v.)开始，发动，进行，继续（战争、战斗等） a remarkable political campaign of _enormous significance_  巨大的意义and sweeping change.
...
The ratification process included _ugly 丑陋的；难看的;令人不快的；危险的；险恶的；凶险的 political manipulation_ 操纵；推拿 as well as brilliant developments in political thought. +
...
In this way, `主` the ratification process itself `谓` helped to create _a national political community_ 国家政治共同体 /后定 *built upon* and *infusing* (v.)使具有，注入（某特性） loyalty *to* distinct (a.)截然不同的；有区别的；不同种类的 states. +
The development of _an American national identity_ was spurred on /and closely linked to the Constitution.
...
The Federalists' efforts and goals `谓` were built upon expanding (v.) this national commitment 国家承诺 and awareness. +
...
+
Their key objection 反对的理由；反对，异议 `谓` challenged the purpose of a central government 后定 that didn't include _specific provisions （法律文件的）规定，条款 后定 protecting (v.) individual rights and liberties_. +

Since the new national government was even more powerful and even more distant 遥远的；远处的;疏远的 from the people, why didn't it *offer* (v.) the kinds of _individual protections_ *in law* 后定 that most _state constitutions_ had come to include by 1776?
...
To the Antifederalists, the SEPARATION OF POWERS 权力分立 was _far too mild (a.)温和的；和善的；不严厉的 a curb_ (n.)起控制（或限制）作用的事物 against the threat of government tyranny. +
...
`主` #This#  `谓` loomed (v.)赫然耸现 状 on the unresolved _political agenda 政治议程 of the national Congress_ /and `主` the adoption （想法、计划、名字等的）采用 of the BILL OF RIGHTS 权利法案 (_the first ten AMENDMENTS_ to the Constitution) `系` #is# a legacy 遗产 of the victory-in-defeat 失败中的胜利 of Antifederalists. +

`主` Their continued (v.) participation in the political process /even when they seemed to have lost (v.) on the more general issue /`谓` had immense  极大的；巨大的 importance.
