...
The indictment  刑事起诉书；公诉书; 控告；起诉 of Waldheim *makes the argument that* Hitler ordered `谓`  *the policy of reprisal* in the Balkans, but that all the details—the quota of hostages taken, the specific arrests and executions, the specific villages burned—were for the local German army intelligence units to work out.
