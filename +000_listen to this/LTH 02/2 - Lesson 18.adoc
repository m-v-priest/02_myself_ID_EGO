...
Mal Carrington: Good morning. Welcome to "The years 后定 to Come". I’m Mal Carrington, and every week at this time /Channel 5 brings you information on *life in the future* /from an expert in the field.
...
Mal Carrington: Yes, however, food production is constantly increasing. Don’t you think we will be able to cope with the increase 后定 in world population?
...
Particularly at this time, with problems 后定 we face at home and abroad.  +
`主` To continue #*to fight*# [through the months ahead] #*for*# my personal vindication 辩护；证明无罪 /`谓` would almost totally absorb (v.) the time and attention /of both the President and the Congress /in a period 后定 when `主` our #entire focus# (n.)中心点（指人或事物） `谓` #should be# on *the great issues* of peace abroad /and prosperity 兴旺；繁荣；成功；昌盛 without inflation at home. (Richard M. Nixon 08/08/74)
