...
\begin{myEnvSample}
\includegraphics[width=0.8\textwidth]{/0008.pdf}

\includegraphics[width=0.4\textwidth]{/0009.pdf}
\end{myEnvSample}
...
\includegraphics[width=0.4\textwidth]{/0010.pdf}
\end{myEnvSample}
...
\begin{myEnvSample}
	...
	\includegraphics[width=0.4\textwidth]{/0011.pdf}
\end{myEnvSample}
...
\includegraphics[width=0.4\textwidth]{/0012.pdf}
...
\begin{myEnvSample}
	...
	\includegraphics[width=0.4\textwidth]{/0021.pdf}
\end{myEnvSample}
...
\begin{myEnvSample}
	...
	\includegraphics[width=0.4\textwidth]{/0022.pdf}
\end{myEnvSample}
...
\includegraphics[width=0.4\textwidth]{/0013.pdf}
...
\begin{myEnvSample}
	...
	\includegraphics[width=0.4\textwidth]{/0014.pdf}
	
	乘法就意味着: 随着 x → 0, 它把``有界函数"的y值, 越来越压缩到趋向于0. 如下图的中间部分趋势: \\
	
	\includegraphics[width=0.4\textwidth]{/0015.pdf}
\end{myEnvSample}
...
\includegraphics[width=0.4\textwidth]{/0016.pdf}

\includegraphics[width=0.4\textwidth]{/0017.pdf}
\end{myEnvSample}
...
\includegraphics[width=0.4\textwidth]{/0018.pdf}
\end{myEnvSample}
...
\begin{myEnvSample}
 在$x \to 0 $时, 	$	\left[ \left( 1+x^2 \right) ^{\frac{1}{3}}-1 \right] \sim \left[ \frac{1}{3}x^2 \right] 	$ \\
	...
	\includegraphics[width=0.4\textwidth]{/0019.pdf}
\end{myEnvSample}
